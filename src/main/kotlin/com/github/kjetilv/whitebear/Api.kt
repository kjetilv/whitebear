...
fun <E, A, R> validate(
    ...
    action: ValidationContext<E, A>.() -> R,
): R =
...
fun <E> simpleFailureModel(empty: E, combiner: (E, E) -> E) =
...
fun <E, A> failureModel(empty: A, combiner: (A, A) -> A, adder: (A, E) -> A) = object : ErrorModel<E, A> {
